...
use AbnDevs\Modules\Process\Installer;
use AbnDevs\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \AbnDevs\Modules\Exceptions\ModuleNotFoundException
     */
